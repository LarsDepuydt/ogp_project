...
public class BreakoutTest {
	...
	void setUp() {
		...
		paddle2 = facade.createReplicatingPaddleState(new Point(4000,5000), 3);
	...
	void movePaddleRight() {
		...
		assertEquals(new Point(2020, 3000), b1.getPaddle().getCenter());
		assertEquals(new Point(4020, 5000), b2.getPaddle().getCenter());
	}
	...
	void movePaddleLeft() {
		b1.movePaddleLeft(1);
		b2.movePaddleLeft(1);
		assertEquals(new Point(1980, 3000), b1.getPaddle().getCenter());
		assertEquals(new Point(3980, 5000), b2.getPaddle().getCenter());
		b1.movePaddleLeft(1);
		b1.movePaddleLeft(1);
		assertEquals(new Point(1940, 3000), b1.getPaddle().getCenter());
	}
