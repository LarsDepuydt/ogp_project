...
public class GameMap {
	...
	private static PaddleState createPaddle(Point topLeft) {
		...
		Vector paddleSize = new Vector(WIDTH/BLOCK_COLUMNS/2,HEIGHT/BLOCK_LINES/8);
		// TODO: return a paddle with given center 
		return new PaddleState(center, paddleSize);
	}
	private static BallState createBall(Point topLeft) {
		...
		return new BallState(center, INIT_BALL_DIAMETER, INIT_BALL_VELOCITY);
	}
