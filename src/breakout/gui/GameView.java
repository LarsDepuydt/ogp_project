...
public class GameView extends JPanel {
	...
	private void paintPaddle(Graphics g) {
		...
		Point tl = new Point(paddle.getCenter().getX() - paddle.getSize().getX(), paddle.getCenter().getY() - paddle.getSize().getY());
		Point br = new Point(paddle.getCenter().getX() + paddle.getSize().getX(), paddle.getCenter().getY() + paddle.getSize().getY());
		paintPaddle(g, tl, br);
	}
	...
	private void paintBalls(Graphics g) {
		...
		for (BallState ball : breakoutState.getBalls()) {
			...
			Point tl = new Point(ball.getCenter().getX() - ball.getDiameter(), ball.getCenter().getY() - ball.getDiameter());
			Point br = new Point(ball.getCenter().getX() + ball.getDiameter(), ball.getCenter().getY() + ball.getDiameter());
			paintBall(g, tl, br);
		}
	}
